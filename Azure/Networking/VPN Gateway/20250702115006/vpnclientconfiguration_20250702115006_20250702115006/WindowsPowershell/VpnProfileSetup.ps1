				...
				<TLSExtensions
					...
					<FilteringInfo
						...
						<CAHashList Enabled="true">
							<IssuerHash>C6 E4 F2 4B D3 C8 C2 93 7D FD 80 67 22 ED 8B F9 57 F0 F8 85 </IssuerHash>
...
$Connection = Get-VpnConnection -Name vnet-p2s-vpn-use2-025
if($connection -ne $null)
{
	try
    {
     if ($Force -eq $false) {
	    ...
	    Remove-VpnConnection -Name vnet-p2s-vpn-use2-025 -Force -ErrorAction Stop
...
try
{
    ...
    {
        Add-VpnConnection -Name vnet-p2s-vpn-use2-025 -ServerAddress azuregateway-d1550078-2c4a-4bdf-a8d7-9515604be792-8715b839853f.vpn.azure.com -TunnelType Ikev2 -AuthenticationMethod Eap -SplitTunneling:$True -RememberCredential -EncryptionLevel Optional -EapConfigXmlStream $EAP -PassThru
    } else {
        Add-VpnConnection -Name vnet-p2s-vpn-use2-025 -ServerAddress azuregateway-d1550078-2c4a-4bdf-a8d7-9515604be792-8715b839853f.vpn.azure.com -TunnelType Ikev2 -AuthenticationMethod MachineCertificate -SplitTunneling:$True -RememberCredential -EncryptionLevel Optional -PassThru
    }
}
catch
{
...
Add-VpnConnectionRoute -ConnectionName vnet-p2s-vpn-use2-025 -DestinationPrefix 10.1.0.0/16
Add-VpnConnectionRoute -ConnectionName vnet-p2s-vpn-use2-025 -DestinationPrefix 172.16.201.0/24
