...
$vmList = @(
    @{ Name = "vm-web-01"; ResourceGroupName = "rg-production-web"; "Action": "start" }
    @{ Name = "vm-app-01"; ResourceGroupName = "rg-production-app"; "Action": "stop" }
    @{ Name = "vm-db-01"; ResourceGroupName = "rg-production-db"; "Action": "restart" }
)
