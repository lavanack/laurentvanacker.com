...
[PooledHostPool]::new($HostPoolSessionCredentialKeyVault, $PrimaryRegionSubnet.Id, $PrimaryRegionPESubnet.Id).SetVMNumberOfInstances(1).DisableAppAttach().EnableScalingPlan()
