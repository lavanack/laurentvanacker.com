...
[PooledHostPool]::new($HostPoolSessionCredentialKeyVault, $PrimaryRegionSubnet.Id, $PrimaryRegionPESubnet.Id).SetIdentityModel([IdentityModel]::CloudOnly).SetVMNumberOfInstances(1).DisableAppAttach()
