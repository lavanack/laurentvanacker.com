...
$MSIXHosts = (Get-ADGroupMember -Identity MSIXHosts).Name
$Session = New-PSSession -ComputerName $MSIXHosts
#Copying the PFX to all session hosts
$Session | ForEach-Object -Process { Copy-Item -Path $CurrentDir\MSIXDigitalSignature.pfx -Destination C:\ -ToSession $_}
Invoke-command -Session $Session -ScriptBlock {
    ...
    Import-PfxCertificate C:\MSIXDigitalSignature.pfx -CertStoreLocation Cert:\LocalMachine\Root\ -Password $SecurePassword
