...
##############################################
$SQLServerISO = 'ISOs\en_sql_server_2019_standard_x64_dvd_cdcd4b9f.iso' #Location of the SQL Server 2019 ISO (https://go.microsoft.com/fwlink/?linkid=866664) (Default: ISOs\SQLServer2019-x64-ENU.iso)
...
$WindowsOperatingSystem = 'Windows Server 2019 Datacenter (Desktop Experience)' #Set the Operating System Type here. Grab the OS with this command: Get-LabAvailableOperatingSystem
